...
void SearchDeletions::outputResultsByMpirank(BDData & g_bdData, ControlState& currentState, std::vector<unsigned> Vars[], const unsigned NumBoxes, const SearchWindow& currentWindow, int mpirank)
{
