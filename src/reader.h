...
bool ReadInBamCrossReads_SR (const char *bam_path,
                        const std::string & FragName,
                        const std::string * CurrentChr,
                        std::vector < SPLIT_READ > &LeftReads,
                        std::vector < SPLIT_READ > & OneEndMappedReads,
...
short get_SR_Cross_Reads(ControlState &currentState, const SearchWindow &currentWindow, unsigned int global_start, unsigned int global_end);
