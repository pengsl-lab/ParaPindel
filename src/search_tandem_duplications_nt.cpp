...
int searchTandemDuplicationsNT(ControlState& currentState, unsigned NumBoxes, const SearchWindow& window, int mpirank)
{
   ...
   std::ofstream TDOutf(userSettings->getTDOutputFilename(mpirank).c_str(), std::ios::app);
